...
const ITEMS_DB = {
  // 枪械 (120件)
  gun: [
    {name: "AK-12", icon: "assets/icons/AK-12.png", quality: "myt", size: 3, priceRange: [150000, 1000000]},
    {name: "AK-47", icon: "assets/icons/AK-47.png", quality: "leg", size: 3, priceRange: [40000, 200000]},
    {name: "AK-74M", icon: "assets/icons/AK-74M.png", quality: "leg", size: 3, priceRange: [40000, 200000]},
    {name: "AKS-74U", icon: "assets/icons/AKS-74U.png", quality: "myt", size: 3, priceRange: [150000, 1000000]},
    {name: "AN-94", icon: "assets/icons/AN-94.png", quality: "myt", size: 3, priceRange: [150000, 1000000]},
    {name: "AUG A1", icon: "assets/icons/AUG_A1.png", quality: "leg", size: 3, priceRange: [40000, 200000]},
    {name: "AUG A3", icon: "assets/icons/AUG_A3.png", quality: "leg", size: 3, priceRange: [40000, 200000]},
    {name: "AUG Para", icon: "assets/icons/AUG_Para.png", quality: "leg", size: 3, priceRange: [40000, 200000]},
    {name: "CZ 805 BREN", icon: "assets/icons/CZ_805_BREN.png", quality: "leg", size: 3, priceRange: [40000, 200000]},
    {name: "FAMAS F1", icon: "assets/icons/FAMAS_F1.png", quality: "leg", size: 3, priceRange: [40000, 200000]},
    {name: "FAMAS G2", icon: "assets/icons/FAMAS_G2.png", quality: "leg", size: 3, priceRange: [40000, 200000]},
    {name: "FAMAS Valoris\u00e9", icon: "assets/icons/FAMAS_Valoris\u00e9.png", quality: "myt", size: 3, priceRange: [150000, 1000000]},
    {name: "FN F2000", icon: "assets/icons/FN_F2000.png", quality: "myt", size: 3, priceRange: [150000, 1000000]},
    {name: "FN FAL", icon: "assets/icons/FN_FAL.png", quality: "myt", size: 3, priceRange: [150000, 1000000]},
    {name: "FN FNC", icon: "assets/icons/FN_FNC.png", quality: "leg", size: 3, priceRange: [40000, 200000]},
    {name: "G36", icon: "assets/icons/G36.png", quality: "myt", size: 3, priceRange: [150000, 1000000]},
    {name: "G36C", icon: "assets/icons/G36C.png", quality: "leg", size: 3, priceRange: [40000, 200000]},
    {name: "Galil ARM", icon: "assets/icons/Galil_ARM.png", quality: "leg", size: 3, priceRange: [40000, 200000]},
    {name: "HK416", icon: "assets/icons/HK416.png", quality: "myt", size: 3, priceRange: [150000, 1000000]},
    {name: "HK53", icon: "assets/icons/HK53.png", quality: "leg", size: 3, priceRange: [40000, 200000]},
    {name: "HK G3", icon: "assets/icons/HK_G3.png", quality: "leg", size: 3, priceRange: [40000, 200000]},
    {name: "M16A1", icon: "assets/icons/M16A1.png", quality: "myt", size: 3, priceRange: [150000, 1000000]},
    {name: "M16A4", icon: "assets/icons/M16A4.png", quality: "leg", size: 3, priceRange: [40000, 200000]},
    {name: "M16A4 M203", icon: "assets/icons/M16A4_M203.png", quality: "myt", size: 3, priceRange: [150000, 1000000]},
    {name: "M4A1", icon: "assets/icons/M4A1.png", quality: "leg", size: 3, priceRange: [40000, 200000]},
    {name: "QBZ-95-1", icon: "assets/icons/QBZ-95-1.png", quality: "leg", size: 3, priceRange: [40000, 200000]},
    {name: "QBZ-95", icon: "assets/icons/QBZ-95.png", quality: "myt", size: 3, priceRange: [150000, 1000000]},
    {name: "SIG SG 550", icon: "assets/icons/SIG_SG_550.png", quality: "leg", size: 3, priceRange: [40000, 200000]},
    {name: "Tavor TAR-21", icon: "assets/icons/Tavor_TAR-21.png", quality: "leg", size: 3, priceRange: [40000, 200000]},
    {name: "VHS-2", icon: "assets/icons/VHS-2.png", quality: "myt", size: 3, priceRange: [150000, 1000000]},
    {name: "AS50", icon: "assets/icons/AS50.png", quality: "myt", size: 4, priceRange: [150000, 1000000]},
    {name: "Accuracy International AWM", icon: "assets/icons/Accuracy_International_AWM.png", quality: "leg", size: 4, priceRange: [40000, 200000]},
    {name: "Barrett M107A1", icon: "assets/icons/Barrett_M107A1.png", quality: "leg", size: 4, priceRange: [40000, 200000]},
    {name: "Barrett M95", icon: "assets/icons/Barrett_M95.png", quality: "myt", size: 4, priceRange: [150000, 1000000]},
    {name: "CheyTac M200 Intervention", icon: "assets/icons/CheyTac_M200_Intervention.png", quality: "myt", size: 4, priceRange: [150000, 1000000]},
    {name: "Desert Tech SRS", icon: "assets/icons/Desert_Tech_SRS.png", quality: "leg", size: 4, priceRange: [40000, 200000]},
    {name: "Dragunov SVD", icon: "assets/icons/Dragunov_SVD.png", quality: "leg", size: 4, priceRange: [40000, 200000]},
    {name: "FN SCAR-H SSR", icon: "assets/icons/FN_SCAR-H_SSR.png", quality: "leg", size: 4, priceRange: [40000, 200000]},
    {name: "HK G3SG1", icon: "assets/icons/HK_G3SG1.png", quality: "leg", size: 4, priceRange: [40000, 200000]},
    {name: "HK PSG-1", icon: "assets/icons/HK_PSG-1.png", quality: "myt", size: 4, priceRange: [150000, 1000000]},
    {name: "KAC SR-25", icon: "assets/icons/KAC_SR-25.png", quality: "leg", size: 4, priceRange: [40000, 200000]},
    {name: "M21", icon: "assets/icons/M21.png", quality: "myt", size: 4, priceRange: [150000, 1000000]},
    {name: "M240D", icon: "assets/icons/M240D.png", quality: "myt", size: 4, priceRange: [150000, 1000000]},
    {name: "M240H", icon: "assets/icons/M240H.png", quality: "myt", size: 4, priceRange: [150000, 1000000]},
    {name: "M249 SAW", icon: "assets/icons/M249_SAW.png", quality: "myt", size: 4, priceRange: [150000, 1000000]},
    {name: "M249 SAW Para", icon: "assets/icons/M249_SAW_Para.png", quality: "myt", size: 4, priceRange: [150000, 1000000]},
    {name: "M40A5", icon: "assets/icons/M40A5.png", quality: "leg", size: 4, priceRange: [40000, 200000]},
    {name: "M4A1", icon: "assets/icons/M4A1.png", quality: "leg", size: 4, priceRange: [40000, 200000]},
    {name: "M60E4", icon: "assets/icons/M60E4.png", quality: "myt", size: 4, priceRange: [150000, 1000000]},
    {name: "M60E6", icon: "assets/icons/M60E6.png", quality: "leg", size: 4, priceRange: [40000, 200000]},
    {name: "Mk 12 SPR", icon: "assets/icons/Mk_12_SPR.png", quality: "myt", size: 4, priceRange: [150000, 1000000]},
    {name: "Mk 14 Mod 0 EBR", icon: "assets/icons/Mk_14_Mod_0_EBR.png", quality: "myt", size: 4, priceRange: [150000, 1000000]},
    {name: "Mk 48 Mod 0", icon: "assets/icons/Mk_48_Mod_0.png", quality: "leg", size: 4, priceRange: [40000, 200000]},
    {name: "RPK-74", icon: "assets/icons/RPK-74.png", quality: "myt", size: 4, priceRange: [150000, 1000000]},
    {name: "Remington 700", icon: "assets/icons/Remington_700.png", quality: "leg", size: 4, priceRange: [40000, 200000]},
    {name: "Remington 700 VLS", icon: "assets/icons/Remington_700_VLS.png", quality: "leg", size: 4, priceRange: [40000, 200000]},
    {name: "Springfield M1A", icon: "assets/icons/Springfield_M1A.png", quality: "myt", size: 4, priceRange: [150000, 1000000]},
    {name: "Steyr SSG 69", icon: "assets/icons/Steyr_SSG_69.png", quality: "leg", size: 4, priceRange: [40000, 200000]},
    {name: "VSS Vintorez", icon: "assets/icons/VSS_Vintorez.png", quality: "leg", size: 4, priceRange: [40000, 200000]},
    {name: "Winchester Model 70", icon: "assets/icons/Winchester_Model_70.png", quality: "myt", size: 4, priceRange: [150000, 1000000]},
    {name: "AK-47", icon: "assets/icons/AK-47.png", quality: "epi", size: 3, priceRange: [8000, 40000]},
    {name: "AK-74", icon: "assets/icons/AK-74.png", quality: "epi", size: 3, priceRange: [8000, 40000]},
    {name: "AK-74M", icon: "assets/icons/AK-74M.png", quality: "rar", size: 3, priceRange: [1500, 8000]},
    {name: "AKM", icon: "assets/icons/AKM.png", quality: "leg", size: 3, priceRange: [40000, 200000]},
    {name: "AKS-74U", icon: "assets/icons/AKS-74U.png", quality: "epi", size: 3, priceRange: [8000, 40000]},
    {name: "CZ 805 BREN", icon: "assets/icons/CZ_805_BREN.png", quality: "rar", size: 3, priceRange: [1500, 8000]},
    {name: "FAMAS F1", icon: "assets/icons/FAMAS_F1.png", quality: "rar", size: 3, priceRange: [1500, 8000]},
    {name: "FAMAS G2", icon: "assets/icons/FAMAS_G2.png", quality: "epi", size: 3, priceRange: [8000, 40000]},
    {name: "FAMAS G2 1", icon: "assets/icons/FAMAS_G2_1.png", quality: "rar", size: 3, priceRange: [1500, 8000]},
    {name: "FAMAS G2 2", icon: "assets/icons/FAMAS_G2_2.png", quality: "epi", size: 3, priceRange: [8000, 40000]},
    {name: "FN F2000", icon: "assets/icons/FN_F2000.png", quality: "rar", size: 3, priceRange: [1500, 8000]},
    {name: "G36", icon: "assets/icons/G36.png", quality: "leg", size: 3, priceRange: [40000, 200000]},
    {name: "G36C", icon: "assets/icons/G36C.png", quality: "leg", size: 3, priceRange: [40000, 200000]},
    {name: "G36K", icon: "assets/icons/G36K.png", quality: "epi", size: 3, priceRange: [8000, 40000]},
    {name: "G3A3", icon: "assets/icons/G3A3.png", quality: "epi", size: 3, priceRange: [8000, 40000]},
    {name: "HK33A2", icon: "assets/icons/HK33A2.png", quality: "leg", size: 3, priceRange: [40000, 200000]},
    {name: "HK53", icon: "assets/icons/HK53.png", quality: "rar", size: 3, priceRange: [1500, 8000]},
    {name: "L85A1", icon: "assets/icons/L85A1.png", quality: "epi", size: 3, priceRange: [8000, 40000]},
    {name: "M16A1", icon: "assets/icons/M16A1.png", quality: "epi", size: 3, priceRange: [8000, 40000]},
    {name: "M16A2", icon: "assets/icons/M16A2.png", quality: "rar", size: 3, priceRange: [1500, 8000]},
    {name: "M16A2 1", icon: "assets/icons/M16A2_1.png", quality: "epi", size: 3, priceRange: [8000, 40000]},
    {name: "M16A2 M203", icon: "assets/icons/M16A2_M203.png", quality: "leg", size: 3, priceRange: [40000, 200000]},
    {name: "M4A1", icon: "assets/icons/M4A1.png", quality: "rar", size: 3, priceRange: [1500, 8000]},
    {name: "MP5SD", icon: "assets/icons/MP5SD.png", quality: "leg", size: 3, priceRange: [40000, 200000]},
    {name: "QBZ-95", icon: "assets/icons/QBZ-95.png", quality: "rar", size: 3, priceRange: [1500, 8000]},
    {name: "QBZ-95B", icon: "assets/icons/QBZ-95B.png", quality: "rar", size: 3, priceRange: [1500, 8000]},
    {name: "SIG SG550", icon: "assets/icons/SIG_SG550.png", quality: "epi", size: 3, priceRange: [8000, 40000]},
    {name: "SIG SG552", icon: "assets/icons/SIG_SG552.png", quality: "rar", size: 3, priceRange: [1500, 8000]},
    {name: "Steyr AUG A1", icon: "assets/icons/Steyr_AUG_A1.png", quality: "rar", size: 3, priceRange: [1500, 8000]},
    {name: "TAR-21", icon: "assets/icons/TAR-21.png", quality: "epi", size: 3, priceRange: [8000, 40000]},
    {name: "AK-12", icon: "assets/icons/AK-12.png", quality: "leg", size: 4, priceRange: [40000, 200000]},
    {name: "AK-47 DMR", icon: "assets/icons/AK-47_DMR.png", quality: "leg", size: 4, priceRange: [40000, 200000]},
    {name: "Accuracy International AW", icon: "assets/icons/Accuracy_International_AW.png", quality: "epi", size: 4, priceRange: [8000, 40000]},
    {name: "ArmaLite AR-10", icon: "assets/icons/ArmaLite_AR-10.png", quality: "myt", size: 4, priceRange: [150000, 1000000]},
    {name: "Barrett M82", icon: "assets/icons/Barrett_M82.png", quality: "leg", size: 4, priceRange: [40000, 200000]},
    {name: "Barrett M95", icon: "assets/icons/Barrett_M95.png", quality: "epi", size: 4, priceRange: [8000, 40000]},
    {name: "Barrett MRAD", icon: "assets/icons/Barrett_MRAD.png", quality: "epi", size: 4, priceRange: [8000, 40000]},
    {name: "DPMS LR-308", icon: "assets/icons/DPMS_LR-308.png", quality: "leg", size: 4, priceRange: [40000, 200000]},
    {name: "Daniel Defense DDM4", icon: "assets/icons/Daniel_Defense_DDM4.png", quality: "epi", size: 4, priceRange: [8000, 40000]},
    {name: "Desert Tech SRS", icon: "assets/icons/Desert_Tech_SRS.png", quality: "leg", size: 4, priceRange: [40000, 200000]},
    {name: "Dragunov SVD", icon: "assets/icons/Dragunov_SVD.png", quality: "epi", size: 4, priceRange: [8000, 40000]},
    {name: "FN SCAR-H SSR", icon: "assets/icons/FN_SCAR-H_SSR.png", quality: "myt", size: 4, priceRange: [150000, 1000000]},
    {name: "HK417", icon: "assets/icons/HK417.png", quality: "myt", size: 4, priceRange: [150000, 1000000]},
    {name: "HK PSG-1", icon: "assets/icons/HK_PSG-1.png", quality: "leg", size: 4, priceRange: [40000, 200000]},
    {name: "IWI Negev", icon: "assets/icons/IWI_Negev.png", quality: "leg", size: 4, priceRange: [40000, 200000]},
    {name: "KAC LAMG", icon: "assets/icons/KAC_LAMG.png", quality: "myt", size: 4, priceRange: [150000, 1000000]},
    {name: "LMT MWS", icon: "assets/icons/LMT_MWS.png", quality: "epi", size: 4, priceRange: [8000, 40000]},
    {name: "LaRue OBR", icon: "assets/icons/LaRue_OBR.png", quality: "leg", size: 4, priceRange: [40000, 200000]},
    {name: "M14 EBR", icon: "assets/icons/M14_EBR.png", quality: "leg", size: 4, priceRange: [40000, 200000]},
    {name: "M14 National Match", icon: "assets/icons/M14_National_Match.png", quality: "epi", size: 4, priceRange: [8000, 40000]},
    {name: "M249 SAW", icon: "assets/icons/M249_SAW.png", quality: "leg", size: 4, priceRange: [40000, 200000]},
    {name: "M60", icon: "assets/icons/M60.png", quality: "myt", size: 4, priceRange: [150000, 1000000]},
    {name: "McMillan TAC-50", icon: "assets/icons/McMillan_TAC-50.png", quality: "epi", size: 4, priceRange: [8000, 40000]},
    {name: "Mk 12 SPR", icon: "assets/icons/Mk_12_SPR.png", quality: "myt", size: 4, priceRange: [150000, 1000000]},
    {name: "Remington 700", icon: "assets/icons/Remington_700.png", quality: "epi", size: 4, priceRange: [8000, 40000]},
    {name: "Ruger Precision Rifle", icon: "assets/icons/Ruger_Precision_Rifle.png", quality: "epi", size: 4, priceRange: [8000, 40000]},
    {name: "SIG MCX", icon: "assets/icons/SIG_MCX.png", quality: "leg", size: 4, priceRange: [40000, 200000]},
    {name: "SR-25", icon: "assets/icons/SR-25.png", quality: "epi", size: 4, priceRange: [8000, 40000]},
    {name: "Sako TRG-42", icon: "assets/icons/Sako_TRG-42.png", quality: "epi", size: 4, priceRange: [8000, 40000]},
    {name: "Winchester Model 70", icon: "assets/icons/Winchester_Model_70.png", quality: "leg", size: 4, priceRange: [40000, 200000]}
  ],
  // 刀刃 (64件)
  blade: [
    {name: "Ancient Styled Dagger", icon: "assets/icons/Ancient_Styled_Dagger.png", quality: "rar", size: 2, priceRange: [1500, 8000]},
    {name: "Assisted Opening Tactical", icon: "assets/icons/Assisted_Opening_Tactical.png", quality: "rar", size: 2, priceRange: [1500, 8000]},
    {name: "Automatic Click Folder", icon: "assets/icons/Automatic_Click_Folder.png", quality: "upg", size: 2, priceRange: [300, 2000]},
    {name: "Automatic Opener", icon: "assets/icons/Automatic_Opener.png", quality: "rar", size: 2, priceRange: [1500, 8000]},
    {name: "Bloclical Knife", icon: "assets/icons/Bloclical_Knife.png", quality: "epi", size: 2, priceRange: [8000, 40000]},
    {name: "Blue Steel Combat", icon: "assets/icons/Blue_Steel_Combat.png", quality: "upg", size: 2, priceRange: [300, 2000]},
    {name: "Bushcraft Knife", icon: "assets/icons/Bushcraft_Knife.png", quality: "civ", size: 2, priceRange: [50, 500]},
    {name: "Button Lock Folder", icon: "assets/icons/Button_Lock_Folder.png", quality: "upg", size: 2, priceRange: [300, 2000]},
    {name: "Damascus Steel Blade", icon: "assets/icons/Damascus_Steel_Blade.png", quality: "rar", size: 2, priceRange: [1500, 8000]},
    {name: "Damascus Steel Blade 2", icon: "assets/icons/Damascus_Steel_Blade_2.png", quality: "upg", size: 2, priceRange: [300, 2000]},
    {name: "Divers Knife", icon: "assets/icons/Divers_Knife.png", quality: "epi", size: 2, priceRange: [8000, 40000]},
    {name: "Fixed Blade SF", icon: "assets/icons/Fixed_Blade_SF.png", quality: "upg", size: 2, priceRange: [300, 2000]},
    {name: "Fixed Blade SF 2", icon: "assets/icons/Fixed_Blade_SF_2.png", quality: "rar", size: 2, priceRange: [1500, 8000]},
    {name: "Fixed G17 Knife", icon: "assets/icons/Fixed_G17_Knife.png", quality: "rar", size: 2, priceRange: [1500, 8000]},
    {name: "Folding EDC Knife", icon: "assets/icons/Folding_EDC_Knife.png", quality: "epi", size: 2, priceRange: [8000, 40000]},
    {name: "Gladius Trainer", icon: "assets/icons/Gladius_Trainer.png", quality: "civ", size: 2, priceRange: [50, 500]},
    {name: "Hunting Fixed Blade", icon: "assets/icons/Hunting_Fixed_Blade.png", quality: "upg", size: 2, priceRange: [300, 2000]},
    {name: "Japanese Tanto", icon: "assets/icons/Japanese_Tanto.png", quality: "civ", size: 2, priceRange: [50, 500]},
    {name: "Karambit Folder", icon: "assets/icons/Karambit_Folder.png", quality: "rar", size: 2, priceRange: [1500, 8000]},
    {name: "Kukri Machete", icon: "assets/icons/Kukri_Machete.png", quality: "epi", size: 2, priceRange: [8000, 40000]},
    {name: "Marine Combat Knife", icon: "assets/icons/Marine_Combat_Knife.png", quality: "civ", size: 2, priceRange: [50, 500]},
    {name: "Pattern Welded Fixed Blade", icon: "assets/icons/Pattern_Welded_Fixed_Blade.png", quality: "epi", size: 2, priceRange: [8000, 40000]},
    {name: "Slaying Fixed Blade", icon: "assets/icons/Slaying_Fixed_Blade.png", quality: "upg", size: 2, priceRange: [300, 2000]},
    {name: "Survival Machete", icon: "assets/icons/Survival_Machete.png", quality: "upg", size: 2, priceRange: [300, 2000]},
    {name: "Tactical Tanto", icon: "assets/icons/Tactical_Tanto.png", quality: "epi", size: 2, priceRange: [8000, 40000]},
    {name: "Throwing Knife Set", icon: "assets/icons/Throwing_Knife_Set.png", quality: "civ", size: 2, priceRange: [50, 500]},
    {name: "Tovin Botted Shok", icon: "assets/icons/Tovin_Botted_Shok.png", quality: "civ", size: 2, priceRange: [50, 500]},
    {name: "Trail Master", icon: "assets/icons/Trail_Master.png", quality: "rar", size: 2, priceRange: [1500, 8000]},
    {name: "Arming Sword", icon: "assets/icons/Arming_Sword.png", quality: "epi", size: 3, priceRange: [8000, 40000]},
    {name: "Assyrian Short Sword", icon: "assets/icons/Assyrian_Short_Sword.png", quality: "epi", size: 3, priceRange: [8000, 40000]},
    {name: "Bastard Sword", icon: "assets/icons/Bastard_Sword.png", quality: "rar", size: 3, priceRange: [1500, 8000]},
    {name: "Brush Sword", icon: "assets/icons/Brush_Sword.png", quality: "leg", size: 3, priceRange: [40000, 200000]},
    {name: "Claymore", icon: "assets/icons/Claymore.png", quality: "myt", size: 3, priceRange: [150000, 1000000]},
    {name: "Combat Knife", icon: "assets/icons/Combat_Knife.png", quality: "epi", size: 3, priceRange: [8000, 40000]},
    {name: "Cursed Katana", icon: "assets/icons/Cursed_Katana.png", quality: "leg", size: 3, priceRange: [40000, 200000]},
    {name: "Custom Combat Sword", icon: "assets/icons/Custom_Combat_Sword.png", quality: "leg", size: 3, priceRange: [40000, 200000]},
    {name: "Dacian Falx", icon: "assets/icons/Dacian_Falx.png", quality: "leg", size: 3, priceRange: [40000, 200000]},
    {name: "Dao", icon: "assets/icons/Dao.png", quality: "leg", size: 3, priceRange: [40000, 200000]},
    {name: "Excalibur", icon: "assets/icons/Excalibur.png", quality: "myt", size: 3, priceRange: [150000, 1000000]},
    {name: "Falcata", icon: "assets/icons/Falcata.png", quality: "epi", size: 3, priceRange: [8000, 40000]},
    {name: "Frostmourne Runeblade", icon: "assets/icons/Frostmourne_Runeblade.png", quality: "epi", size: 3, priceRange: [8000, 40000]},
    {name: "Holy Avenger", icon: "assets/icons/Holy_Avenger.png", quality: "leg", size: 3, priceRange: [40000, 200000]},
    {name: "Jian", icon: "assets/icons/Jian.png", quality: "rar", size: 3, priceRange: [1500, 8000]},
    {name: "Katana", icon: "assets/icons/Katana.png", quality: "leg", size: 3, priceRange: [40000, 200000]},
    {name: "Kukri", icon: "assets/icons/Kukri.png", quality: "epi", size: 3, priceRange: [8000, 40000]},
    {name: "Longsword", icon: "assets/icons/Longsword.png", quality: "myt", size: 3, priceRange: [150000, 1000000]},
    {name: "Machete", icon: "assets/icons/Machete.png", quality: "rar", size: 3, priceRange: [1500, 8000]},
    {name: "Messer", icon: "assets/icons/Messer.png", quality: "leg", size: 3, priceRange: [40000, 200000]},
    {name: "Multi Tool Axe", icon: "assets/icons/Multi_Tool_Axe.png", quality: "rar", size: 3, priceRange: [1500, 8000]},
    {name: "Nodachi", icon: "assets/icons/Nodachi.png", quality: "myt", size: 3, priceRange: [150000, 1000000]},
    {name: "Non Lethal Baton", icon: "assets/icons/Non_Lethal_Baton.png", quality: "epi", size: 3, priceRange: [8000, 40000]},
    {name: "Roman Gladius", icon: "assets/icons/Roman_Gladius.png", quality: "epi", size: 3, priceRange: [8000, 40000]},
    {name: "Scimitar", icon: "assets/icons/Scimitar.png", quality: "rar", size: 3, priceRange: [1500, 8000]},
    {name: "Spatha", icon: "assets/icons/Spatha.png", quality: "myt", size: 3, priceRange: [150000, 1000000]},
    {name: "Specialized Survival Blade", icon: "assets/icons/Specialized_Survival_Blade.png", quality: "leg", size: 3, priceRange: [40000, 200000]},
    {name: "Specialized Training Blade", icon: "assets/icons/Specialized_Training_Blade.png", quality: "leg", size: 3, priceRange: [40000, 200000]},
    {name: "Sunblade", icon: "assets/icons/Sunblade.png", quality: "rar", size: 3, priceRange: [1500, 8000]},
    {name: "Survival Blade", icon: "assets/icons/Survival_Blade.png", quality: "leg", size: 3, priceRange: [40000, 200000]},
    {name: "Tactical Machete", icon: "assets/icons/Tactical_Machete.png", quality: "rar", size: 3, priceRange: [1500, 8000]},
    {name: "Tactical Tomahawk", icon: "assets/icons/Tactical_Tomahawk.png", quality: "epi", size: 3, priceRange: [8000, 40000]},
    {name: "Vorpal Blade", icon: "assets/icons/Vorpal_Blade.png", quality: "epi", size: 3, priceRange: [8000, 40000]},
    {name: "Wakizashi", icon: "assets/icons/Wakizashi.png", quality: "epi", size: 3, priceRange: [8000, 40000]},
    {name: "Xiphos", icon: "assets/icons/Xiphos.png", quality: "rar", size: 3, priceRange: [1500, 8000]},
    {name: "Zweihander", icon: "assets/icons/Zweihander.png", quality: "rar", size: 3, priceRange: [1500, 8000]}
  ],
  // 装备 (128件)
  equip: [
    {name: "ACH Helmet MultiCam", icon: "assets/icons/ACH_Helmet_MultiCam.png", quality: "upg", size: 2, priceRange: [300, 2000]},
    {name: "ACH Helmet NVG", icon: "assets/icons/ACH_Helmet_NVG.png", quality: "epi", size: 2, priceRange: [8000, 40000]},
    {name: "ACH Helmet Rails", icon: "assets/icons/ACH_Helmet_Rails.png", quality: "epi", size: 2, priceRange: [8000, 40000]},
    {name: "ACH Helmet Tan Rails", icon: "assets/icons/ACH_Helmet_Tan_Rails.png", quality: "epi", size: 2, priceRange: [8000, 40000]},
    {name: "Advanced Plate Carrier", icon: "assets/icons/Advanced_Plate_Carrier.png", quality: "rar", size: 2, priceRange: [1500, 8000]},
    {name: "Airframe Helmet", icon: "assets/icons/Airframe_Helmet.png", quality: "upg", size: 2, priceRange: [300, 2000]},
    {name: "Airframe Helmet Mandible", icon: "assets/icons/Airframe_Helmet_Mandible.png", quality: "rar", size: 2, priceRange: [1500, 8000]},
    {name: "Airframe Helmet MultiCam", icon: "assets/icons/Airframe_Helmet_MultiCam.png", quality: "epi", size: 2, priceRange: [8000, 40000]},
    {name: "Airframe Helmet Olive", icon: "assets/icons/Airframe_Helmet_Olive.png", quality: "epi", size: 2, priceRange: [8000, 40000]},
    {name: "Airframe Helmet Visor", icon: "assets/icons/Airframe_Helmet_Visor.png", quality: "epi", size: 2, priceRange: [8000, 40000]},
    {name: "Assault Pack", icon: "assets/icons/Assault_Pack.png", quality: "rar", size: 2, priceRange: [1500, 8000]},
    {name: "Assault Pack Black", icon: "assets/icons/Assault_Pack_Black.png", quality: "upg", size: 2, priceRange: [300, 2000]},
    {name: "Assault Pack Large", icon: "assets/icons/Assault_Pack_Large.png", quality: "upg", size: 2, priceRange: [300, 2000]},
    {name: "Assault Pack Tan", icon: "assets/icons/Assault_Pack_Tan.png", quality: "leg", size: 2, priceRange: [40000, 200000]},
    {name: "Badge Confidential Blue", icon: "assets/icons/Badge_Confidential_Blue.png", quality: "upg", size: 2, priceRange: [300, 2000]},
    {name: "Badge Secret Green", icon: "assets/icons/Badge_Secret_Green.png", quality: "rar", size: 2, priceRange: [1500, 8000]},
    {name: "Badge TS SCI Red", icon: "assets/icons/Badge_TS_SCI_Red.png", quality: "rar", size: 2, priceRange: [1500, 8000]},
    {name: "Ballistic Helmet Visor", icon: "assets/icons/Ballistic_Helmet_Visor.png", quality: "leg", size: 2, priceRange: [40000, 200000]},
    {name: "Ballistic Riot Helmet", icon: "assets/icons/Ballistic_Riot_Helmet.png", quality: "epi", size: 2, priceRange: [8000, 40000]},
    {name: "Battle Belt Vest Enhanced", icon: "assets/icons/Battle_Belt_Vest_Enhanced.png", quality: "upg", size: 2, priceRange: [300, 2000]},
    {name: "Battle Belt Vest Olive", icon: "assets/icons/Battle_Belt_Vest_Olive.png", quality: "rar", size: 2, priceRange: [1500, 8000]},
    {name: "Battle Belt Vest Tan", icon: "assets/icons/Battle_Belt_Vest_Tan.png", quality: "upg", size: 2, priceRange: [300, 2000]},
    {name: "Chest Rig Vest Tan", icon: "assets/icons/Chest_Rig_Vest_Tan.png", quality: "rar", size: 2, priceRange: [1500, 8000]},
    {name: "Classified Document Red", icon: "assets/icons/Classified_Document_Red.png", quality: "epi", size: 2, priceRange: [8000, 40000]},
    {name: "Compact Pack", icon: "assets/icons/Compact_Pack.png", quality: "upg", size: 2, priceRange: [300, 2000]},
    {name: "Compact Pack Black", icon: "assets/icons/Compact_Pack_Black.png", quality: "epi", size: 2, priceRange: [8000, 40000]},
    {name: "Compact Pack Black Plus", icon: "assets/icons/Compact_Pack_Black_Plus.png", quality: "upg", size: 2, priceRange: [300, 2000]},
    {name: "Compact Pack Plus", icon: "assets/icons/Compact_Pack_Plus.png", quality: "upg", size: 2, priceRange: [300, 2000]},
    {name: "Concealable Carrier", icon: "assets/icons/Concealable_Carrier.png", quality: "epi", size: 2, priceRange: [8000, 40000]},
    {name: "Concealable Carrier Enhanced", icon: "assets/icons/Concealable_Carrier_Enhanced.png", quality: "epi", size: 2, priceRange: [8000, 40000]},
    {name: "Drone Operator Vest", icon: "assets/icons/Drone_Operator_Vest.png", quality: "upg", size: 2, priceRange: [300, 2000]},
    {name: "Drone Vest Olive", icon: "assets/icons/Drone_Vest_Olive.png", quality: "epi", size: 2, priceRange: [8000, 40000]},
    {name: "Drone Vest Tan", icon: "assets/icons/Drone_Vest_Tan.png", quality: "rar", size: 2, priceRange: [1500, 8000]},
    {name: "EOD Bomb Helmet", icon: "assets/icons/EOD_Bomb_Helmet.png", quality: "rar", size: 2, priceRange: [1500, 8000]},
    {name: "EOD Carrier Olive", icon: "assets/icons/EOD_Carrier_Olive.png", quality: "epi", size: 2, priceRange: [8000, 40000]},
    {name: "EOD Carrier Tan", icon: "assets/icons/EOD_Carrier_Tan.png", quality: "rar", size: 2, priceRange: [1500, 8000]},
    {name: "EOD Full Suit Complete", icon: "assets/icons/EOD_Full_Suit_Complete.png", quality: "rar", size: 2, priceRange: [1500, 8000]},
    {name: "EOD Full Suit Vest", icon: "assets/icons/EOD_Full_Suit_Vest.png", quality: "rar", size: 2, priceRange: [1500, 8000]},
    {name: "EOD Pack Heavy", icon: "assets/icons/EOD_Pack_Heavy.png", quality: "upg", size: 2, priceRange: [300, 2000]},
    {name: "EOD Plate Carrier", icon: "assets/icons/EOD_Plate_Carrier.png", quality: "rar", size: 2, priceRange: [1500, 8000]},
    {name: "EOD Tactical Pack", icon: "assets/icons/EOD_Tactical_Pack.png", quality: "rar", size: 2, priceRange: [1500, 8000]},
    {name: "Elite Ops Pack Black", icon: "assets/icons/Elite_Ops_Pack_Black.png", quality: "rar", size: 2, priceRange: [1500, 8000]},
    {name: "Elite Ops Pack Tan", icon: "assets/icons/Elite_Ops_Pack_Tan.png", quality: "leg", size: 2, priceRange: [40000, 200000]},
    {name: "Encrypted Hard Drive", icon: "assets/icons/Encrypted_Hard_Drive.png", quality: "rar", size: 2, priceRange: [1500, 8000]},
    {name: "Enhanced Plate Carrier", icon: "assets/icons/Enhanced_Plate_Carrier.png", quality: "epi", size: 2, priceRange: [8000, 40000]},
    {name: "Equipment Case Medium", icon: "assets/icons/Equipment_Case_Medium.png", quality: "epi", size: 2, priceRange: [8000, 40000]},
    {name: "Equipment Case Small", icon: "assets/icons/Equipment_Case_Small.png", quality: "rar", size: 2, priceRange: [1500, 8000]},
    {name: "Exoskeleton Vest", icon: "assets/icons/Exoskeleton_Vest.png", quality: "rar", size: 2, priceRange: [1500, 8000]},
    {name: "Exoskeleton Vest Olive", icon: "assets/icons/Exoskeleton_Vest_Olive.png", quality: "epi", size: 2, priceRange: [8000, 40000]},
    {name: "Exoskeleton Vest Tan", icon: "assets/icons/Exoskeleton_Vest_Tan.png", quality: "upg", size: 2, priceRange: [300, 2000]},
    {name: "Extended Assault Pack", icon: "assets/icons/Extended_Assault_Pack.png", quality: "rar", size: 2, priceRange: [1500, 8000]},
    {name: "Extended Assault Pack Reinforced", icon: "assets/icons/Extended_Assault_Pack_Reinforced.png", quality: "rar", size: 2, priceRange: [1500, 8000]},
    {name: "FAST Helmet Ballistic", icon: "assets/icons/FAST_Helmet_Ballistic.png", quality: "upg", size: 2, priceRange: [300, 2000]},
    {name: "FAST Helmet Ballistic Tan", icon: "assets/icons/FAST_Helmet_Ballistic_Tan.png", quality: "epi", size: 2, priceRange: [8000, 40000]},
    {name: "FAST Helmet Base", icon: "assets/icons/FAST_Helmet_Base.png", quality: "rar", size: 2, priceRange: [1500, 8000]},
    {name: "FAST Helmet Maritime", icon: "assets/icons/FAST_Helmet_Maritime.png", quality: "epi", size: 2, priceRange: [8000, 40000]},
    {name: "FAST Helmet Tan", icon: "assets/icons/FAST_Helmet_Tan.png", quality: "leg", size: 2, priceRange: [40000, 200000]},
    {name: "Field Manual", icon: "assets/icons/Field_Manual.png", quality: "rar", size: 2, priceRange: [1500, 8000]},
    {name: "Full Coverage Carrier", icon: "assets/icons/Full_Coverage_Carrier.png", quality: "upg", size: 2, priceRange: [300, 2000]},
    {name: "Full Protection Vest", icon: "assets/icons/Full_Protection_Vest.png", quality: "rar", size: 2, priceRange: [1500, 8000]},
    {name: "Handheld Radio", icon: "assets/icons/Handheld_Radio.png", quality: "upg", size: 2, priceRange: [300, 2000]},
    {name: "Heavy Assault Pack", icon: "assets/icons/Heavy_Assault_Pack.png", quality: "epi", size: 2, priceRange: [8000, 40000]},
    {name: "Heavy Assault Pack Black", icon: "assets/icons/Heavy_Assault_Pack_Black.png", quality: "rar", size: 2, priceRange: [1500, 8000]},
    {name: "Heavy Ballistic Helmet", icon: "assets/icons/Heavy_Ballistic_Helmet.png", quality: "epi", size: 2, priceRange: [8000, 40000]},
    {name: "Heavy Modular Vest", icon: "assets/icons/Heavy_Modular_Vest.png", quality: "epi", size: 2, priceRange: [8000, 40000]},
    {name: "Heavy Plate Carrier", icon: "assets/icons/Heavy_Plate_Carrier.png", quality: "leg", size: 2, priceRange: [40000, 200000]},
    {name: "Heavy Plate Carrier Olive", icon: "assets/icons/Heavy_Plate_Carrier_Olive.png", quality: "upg", size: 2, priceRange: [300, 2000]},
    {name: "Heavy Plate Carrier Tan", icon: "assets/icons/Heavy_Plate_Carrier_Tan.png", quality: "upg", size: 2, priceRange: [300, 2000]},
    {name: "ID Card Blue Contractor", icon: "assets/icons/ID_Card_Blue_Contractor.png", quality: "rar", size: 2, priceRange: [1500, 8000]},
    {name: "ID Card Green Enlisted", icon: "assets/icons/ID_Card_Green_Enlisted.png", quality: "upg", size: 2, priceRange: [300, 2000]},
    {name: "ID Card Red Officer", icon: "assets/icons/ID_Card_Red_Officer.png", quality: "upg", size: 2, priceRange: [300, 2000]},
    {name: "Intel Folder", icon: "assets/icons/Intel_Folder.png", quality: "epi", size: 2, priceRange: [8000, 40000]},
    {name: "JTAC Vest Enhanced", icon: "assets/icons/JTAC_Vest_Enhanced.png", quality: "upg", size: 2, priceRange: [300, 2000]},
    {name: "JTAC Vest Radio", icon: "assets/icons/JTAC_Vest_Radio.png", quality: "rar", size: 2, priceRange: [1500, 8000]},
    {name: "LR Patrol Pack", icon: "assets/icons/LR_Patrol_Pack.png", quality: "rar", size: 2, priceRange: [1500, 8000]},
    {name: "LR Patrol Pack Black", icon: "assets/icons/LR_Patrol_Pack_Black.png", quality: "upg", size: 2, priceRange: [300, 2000]},
    {name: "Large Tactical Ruck", icon: "assets/icons/Large_Tactical_Ruck.png", quality: "upg", size: 2, priceRange: [300, 2000]},
    {name: "Large Tactical Ruck Black", icon: "assets/icons/Large_Tactical_Ruck_Black.png", quality: "epi", size: 2, priceRange: [8000, 40000]},
    {name: "Light Field Pack", icon: "assets/icons/Light_Field_Pack.png", quality: "rar", size: 2, priceRange: [1500, 8000]},
    {name: "Light Field Pack Tan", icon: "assets/icons/Light_Field_Pack_Tan.png", quality: "rar", size: 2, priceRange: [1500, 8000]},
    {name: "Light Plate Carrier", icon: "assets/icons/Light_Plate_Carrier.png", quality: "upg", size: 2, priceRange: [300, 2000]},
    {name: "Long Range Radio", icon: "assets/icons/Long_Range_Radio.png", quality: "rar", size: 2, priceRange: [1500, 8000]},
    {name: "MICH Helmet", icon: "assets/icons/MICH_Helmet.png", quality: "leg", size: 2, priceRange: [40000, 200000]},
    {name: "MICH Helmet MultiCam", icon: "assets/icons/MICH_Helmet_MultiCam.png", quality: "leg", size: 2, priceRange: [40000, 200000]},
    {name: "MICH Helmet NVG Mount", icon: "assets/icons/MICH_Helmet_NVG_Mount.png", quality: "epi", size: 2, priceRange: [8000, 40000]},
    {name: "MICH Helmet Tan", icon: "assets/icons/MICH_Helmet_Tan.png", quality: "leg", size: 2, priceRange: [40000, 200000]},
    {name: "Medic Assault Pack", icon: "assets/icons/Medic_Assault_Pack.png", quality: "upg", size: 2, priceRange: [300, 2000]},
    {name: "Medic Field Pack", icon: "assets/icons/Medic_Field_Pack.png", quality: "epi", size: 2, priceRange: [8000, 40000]},
    {name: "Medic Field Pack Black", icon: "assets/icons/Medic_Field_Pack_Black.png", quality: "rar", size: 2, priceRange: [1500, 8000]},
    {name: "Medic Pack Black", icon: "assets/icons/Medic_Pack_Black.png", quality: "leg", size: 2, priceRange: [40000, 200000]},
    {name: "Medium Tactical Pack", icon: "assets/icons/Medium_Tactical_Pack.png", quality: "epi", size: 2, priceRange: [8000, 40000]},
    {name: "Medium Tactical Pack Tan", icon: "assets/icons/Medium_Tactical_Pack_Tan.png", quality: "upg", size: 2, priceRange: [300, 2000]},
    {name: "Modular Tactical Vest", icon: "assets/icons/Modular_Tactical_Vest.png", quality: "upg", size: 2, priceRange: [300, 2000]},
    {name: "Modular Vest Enhanced", icon: "assets/icons/Modular_Vest_Enhanced.png", quality: "leg", size: 2, priceRange: [40000, 200000]},
    {name: "Operator Carrier Full", icon: "assets/icons/Operator_Carrier_Full.png", quality: "leg", size: 2, priceRange: [40000, 200000]},
    {name: "Operator Carrier Olive", icon: "assets/icons/Operator_Carrier_Olive.png", quality: "rar", size: 2, priceRange: [1500, 8000]},
    {name: "Operator Carrier Tan", icon: "assets/icons/Operator_Carrier_Tan.png", quality: "leg", size: 2, priceRange: [40000, 200000]},
    {name: "PASGT Helmet", icon: "assets/icons/PASGT_Helmet.png", quality: "rar", size: 2, priceRange: [1500, 8000]},
    {name: "PASGT Helmet Tan", icon: "assets/icons/PASGT_Helmet_Tan.png", quality: "leg", size: 2, priceRange: [40000, 200000]},
    {name: "PASGT Helmet Woodland", icon: "assets/icons/PASGT_Helmet_Woodland.png", quality: "epi", size: 2, priceRange: [8000, 40000]},
    {name: "Plate Carrier Olive", icon: "assets/icons/Plate_Carrier_Olive.png", quality: "epi", size: 2, priceRange: [8000, 40000]},
    {name: "Plate Carrier Pouched", icon: "assets/icons/Plate_Carrier_Pouched.png", quality: "epi", size: 2, priceRange: [8000, 40000]},
    {name: "Powered Armor Enhanced", icon: "assets/icons/Powered_Armor_Enhanced.png", quality: "upg", size: 2, priceRange: [300, 2000]},
    {name: "Powered Armor Full", icon: "assets/icons/Powered_Armor_Full.png", quality: "rar", size: 2, priceRange: [1500, 8000]},
    {name: "Powered Armor Vest", icon: "assets/icons/Powered_Armor_Vest.png", quality: "leg", size: 2, priceRange: [40000, 200000]},
    {name: "Recon Pack", icon: "assets/icons/Recon_Pack.png", quality: "epi", size: 2, priceRange: [8000, 40000]},
    {name: "Recon Pack Expanded", icon: "assets/icons/Recon_Pack_Expanded.png", quality: "rar", size: 2, priceRange: [1500, 8000]},
    {name: "Recon Pack Tan", icon: "assets/icons/Recon_Pack_Tan.png", quality: "upg", size: 2, priceRange: [300, 2000]},
    {name: "Recon Pack Tan Expanded", icon: "assets/icons/Recon_Pack_Tan_Expanded.png", quality: "upg", size: 2, priceRange: [300, 2000]},
    {name: "Riot Helmet Visor", icon: "assets/icons/Riot_Helmet_Visor.png", quality: "leg", size: 2, priceRange: [40000, 200000]},
    {name: "SIGINT Pack Black", icon: "assets/icons/SIGINT_Pack_Black.png", quality: "leg", size: 2, priceRange: [40000, 200000]},
    {name: "SIGINT Pack Tan", icon: "assets/icons/SIGINT_Pack_Tan.png", quality: "upg", size: 2, priceRange: [300, 2000]},
    {name: "SSD Military Black", icon: "assets/icons/SSD_Military_Black.png", quality: "rar", size: 2, priceRange: [1500, 8000]},
    {name: "SSD Military Olive", icon: "assets/icons/SSD_Military_Olive.png", quality: "rar", size: 2, priceRange: [1500, 8000]},
    {name: "SSD Military Tan", icon: "assets/icons/SSD_Military_Tan.png", quality: "upg", size: 2, priceRange: [300, 2000]},
    {name: "Secure Case Large", icon: "assets/icons/Secure_Case_Large.png", quality: "rar", size: 2, priceRange: [1500, 8000]},
    {name: "Secure Smartphone", icon: "assets/icons/Secure_Smartphone.png", quality: "leg", size: 2, priceRange: [40000, 200000]},
    {name: "Slick Carrier Admin", icon: "assets/icons/Slick_Carrier_Admin.png", quality: "leg", size: 2, priceRange: [40000, 200000]},
    {name: "Slick Plate Carrier", icon: "assets/icons/Slick_Plate_Carrier.png", quality: "epi", size: 2, priceRange: [8000, 40000]},
    {name: "Standard Field Pack", icon: "assets/icons/Standard_Field_Pack.png", quality: "upg", size: 2, priceRange: [300, 2000]},
    {name: "Standard Field Pack Alt", icon: "assets/icons/Standard_Field_Pack_Alt.png", quality: "leg", size: 2, priceRange: [40000, 200000]},
    {name: "Standard Field Pack Tan", icon: "assets/icons/Standard_Field_Pack_Tan.png", quality: "upg", size: 2, priceRange: [300, 2000]},
    {name: "Standard Field Pack Tan Alt", icon: "assets/icons/Standard_Field_Pack_Tan_Alt.png", quality: "leg", size: 2, priceRange: [40000, 200000]},
    {name: "Standard Plate Carrier", icon: "assets/icons/Standard_Plate_Carrier.png", quality: "upg", size: 2, priceRange: [300, 2000]},
    {name: "Tactical Tablet", icon: "assets/icons/Tactical_Tablet.png", quality: "upg", size: 2, priceRange: [300, 2000]},
    {name: "Urban Pack Reinforced", icon: "assets/icons/Urban_Pack_Reinforced.png", quality: "epi", size: 2, priceRange: [8000, 40000]},
    {name: "Urban Tactical Pack", icon: "assets/icons/Urban_Tactical_Pack.png", quality: "upg", size: 2, priceRange: [300, 2000]},
    {name: "Weapons Case", icon: "assets/icons/Weapons_Case.png", quality: "upg", size: 2, priceRange: [300, 2000]}
  ],
  // 配件 (191件)
  part: [
    {name: "Gold Grip 1", icon: "assets/icons/Gold_Grip_1.png", quality: "civ", size: 1, priceRange: [50, 500]},
    {name: "Gold Grip 10", icon: "assets/icons/Gold_Grip_10.png", quality: "civ", size: 1, priceRange: [50, 500]},
    {name: "Gold Grip 11", icon: "assets/icons/Gold_Grip_11.png", quality: "civ", size: 1, priceRange: [50, 500]},
    {name: "Gold Grip 12", icon: "assets/icons/Gold_Grip_12.png", quality: "rar", size: 1, priceRange: [1500, 8000]},
    {name: "Gold Grip 13", icon: "assets/icons/Gold_Grip_13.png", quality: "rar", size: 1, priceRange: [1500, 8000]},
    {name: "Gold Grip 14", icon: "assets/icons/Gold_Grip_14.png", quality: "civ", size: 1, priceRange: [50, 500]},
    {name: "Gold Grip 15", icon: "assets/icons/Gold_Grip_15.png", quality: "rar", size: 1, priceRange: [1500, 8000]},
    {name: "Gold Grip 16", icon: "assets/icons/Gold_Grip_16.png", quality: "rar", size: 1, priceRange: [1500, 8000]},
    {name: "Gold Grip 2", icon: "assets/icons/Gold_Grip_2.png", quality: "civ", size: 1, priceRange: [50, 500]},
    {name: "Gold Grip 3", icon: "assets/icons/Gold_Grip_3.png", quality: "civ", size: 1, priceRange: [50, 500]},
    {name: "Gold Grip 4", icon: "assets/icons/Gold_Grip_4.png", quality: "rar", size: 1, priceRange: [1500, 8000]},
    {name: "Gold Grip 5", icon: "assets/icons/Gold_Grip_5.png", quality: "civ", size: 1, priceRange: [50, 500]},
    {name: "Gold Grip 6", icon: "assets/icons/Gold_Grip_6.png", quality: "rar", size: 1, priceRange: [1500, 8000]},
    {name: "Gold Grip 7", icon: "assets/icons/Gold_Grip_7.png", quality: "civ", size: 1, priceRange: [50, 500]},
    {name: "Gold Grip 8", icon: "assets/icons/Gold_Grip_8.png", quality: "upg", size: 1, priceRange: [300, 2000]},
    {name: "Gold Grip 9", icon: "assets/icons/Gold_Grip_9.png", quality: "civ", size: 1, priceRange: [50, 500]},
    {name: "Gold Magazine 1", icon: "assets/icons/Gold_Magazine_1.png", quality: "rar", size: 1, priceRange: [1500, 8000]},
    {name: "Gold Magazine 10", icon: "assets/icons/Gold_Magazine_10.png", quality: "civ", size: 1, priceRange: [50, 500]},
    {name: "Gold Magazine 11", icon: "assets/icons/Gold_Magazine_11.png", quality: "civ", size: 1, priceRange: [50, 500]},
    {name: "Gold Magazine 12", icon: "assets/icons/Gold_Magazine_12.png", quality: "upg", size: 1, priceRange: [300, 2000]},
    {name: "Gold Magazine 13", icon: "assets/icons/Gold_Magazine_13.png", quality: "rar", size: 1, priceRange: [1500, 8000]},
    {name: "Gold Magazine 14", icon: "assets/icons/Gold_Magazine_14.png", quality: "upg", size: 1, priceRange: [300, 2000]},
    {name: "Gold Magazine 15", icon: "assets/icons/Gold_Magazine_15.png", quality: "rar", size: 1, priceRange: [1500, 8000]},
    {name: "Gold Magazine 16", icon: "assets/icons/Gold_Magazine_16.png", quality: "civ", size: 1, priceRange: [50, 500]},
    {name: "Gold Magazine 2", icon: "assets/icons/Gold_Magazine_2.png", quality: "upg", size: 1, priceRange: [300, 2000]},
    {name: "Gold Magazine 3", icon: "assets/icons/Gold_Magazine_3.png", quality: "rar", size: 1, priceRange: [1500, 8000]},
    {name: "Gold Magazine 4", icon: "assets/icons/Gold_Magazine_4.png", quality: "rar", size: 1, priceRange: [1500, 8000]},
    {name: "Gold Magazine 5", icon: "assets/icons/Gold_Magazine_5.png", quality: "civ", size: 1, priceRange: [50, 500]},
    {name: "Gold Magazine 6", icon: "assets/icons/Gold_Magazine_6.png", quality: "civ", size: 1, priceRange: [50, 500]},
    {name: "Gold Magazine 7", icon: "assets/icons/Gold_Magazine_7.png", quality: "rar", size: 1, priceRange: [1500, 8000]},
    {name: "Gold Magazine 8", icon: "assets/icons/Gold_Magazine_8.png", quality: "rar", size: 1, priceRange: [1500, 8000]},
    {name: "Gold Magazine 9", icon: "assets/icons/Gold_Magazine_9.png", quality: "civ", size: 1, priceRange: [50, 500]},
    {name: "Gold Reflex Sight 1", icon: "assets/icons/Gold_Reflex_Sight_1.png", quality: "civ", size: 1, priceRange: [50, 500]},
    {name: "Gold Reflex Sight 10", icon: "assets/icons/Gold_Reflex_Sight_10.png", quality: "civ", size: 1, priceRange: [50, 500]},
    {name: "Gold Reflex Sight 11", icon: "assets/icons/Gold_Reflex_Sight_11.png", quality: "upg", size: 1, priceRange: [300, 2000]},
    {name: "Gold Reflex Sight 12", icon: "assets/icons/Gold_Reflex_Sight_12.png", quality: "civ", size: 1, priceRange: [50, 500]},
    {name: "Gold Reflex Sight 13", icon: "assets/icons/Gold_Reflex_Sight_13.png", quality: "civ", size: 1, priceRange: [50, 500]},
    {name: "Gold Reflex Sight 14", icon: "assets/icons/Gold_Reflex_Sight_14.png", quality: "rar", size: 1, priceRange: [1500, 8000]},
    {name: "Gold Reflex Sight 15", icon: "assets/icons/Gold_Reflex_Sight_15.png", quality: "upg", size: 1, priceRange: [300, 2000]},
    {name: "Gold Reflex Sight 16", icon: "assets/icons/Gold_Reflex_Sight_16.png", quality: "upg", size: 1, priceRange: [300, 2000]},
    {name: "Gold Reflex Sight 2", icon: "assets/icons/Gold_Reflex_Sight_2.png", quality: "upg", size: 1, priceRange: [300, 2000]},
    {name: "Gold Reflex Sight 3", icon: "assets/icons/Gold_Reflex_Sight_3.png", quality: "upg", size: 1, priceRange: [300, 2000]},
    {name: "Gold Reflex Sight 4", icon: "assets/icons/Gold_Reflex_Sight_4.png", quality: "civ", size: 1, priceRange: [50, 500]},
    {name: "Gold Reflex Sight 5", icon: "assets/icons/Gold_Reflex_Sight_5.png", quality: "rar", size: 1, priceRange: [1500, 8000]},
    {name: "Gold Reflex Sight 6", icon: "assets/icons/Gold_Reflex_Sight_6.png", quality: "upg", size: 1, priceRange: [300, 2000]},
    {name: "Gold Reflex Sight 7", icon: "assets/icons/Gold_Reflex_Sight_7.png", quality: "rar", size: 1, priceRange: [1500, 8000]},
    {name: "Gold Reflex Sight 8", icon: "assets/icons/Gold_Reflex_Sight_8.png", quality: "upg", size: 1, priceRange: [300, 2000]},
    {name: "Gold Reflex Sight 9", icon: "assets/icons/Gold_Reflex_Sight_9.png", quality: "upg", size: 1, priceRange: [300, 2000]},
    {name: "Gold Scope 1", icon: "assets/icons/Gold_Scope_1.png", quality: "civ", size: 1, priceRange: [50, 500]},
    {name: "Gold Scope 10", icon: "assets/icons/Gold_Scope_10.png", quality: "rar", size: 1, priceRange: [1500, 8000]},
    {name: "Gold Scope 11", icon: "assets/icons/Gold_Scope_11.png", quality: "civ", size: 1, priceRange: [50, 500]},
    {name: "Gold Scope 12", icon: "assets/icons/Gold_Scope_12.png", quality: "rar", size: 1, priceRange: [1500, 8000]},
    {name: "Gold Scope 13", icon: "assets/icons/Gold_Scope_13.png", quality: "rar", size: 1, priceRange: [1500, 8000]},
    {name: "Gold Scope 14", icon: "assets/icons/Gold_Scope_14.png", quality: "rar", size: 1, priceRange: [1500, 8000]},
    {name: "Gold Scope 15", icon: "assets/icons/Gold_Scope_15.png", quality: "rar", size: 1, priceRange: [1500, 8000]},
    {name: "Gold Scope 16", icon: "assets/icons/Gold_Scope_16.png", quality: "rar", size: 1, priceRange: [1500, 8000]},
    {name: "Gold Scope 2", icon: "assets/icons/Gold_Scope_2.png", quality: "upg", size: 1, priceRange: [300, 2000]},
    {name: "Gold Scope 3", icon: "assets/icons/Gold_Scope_3.png", quality: "civ", size: 1, priceRange: [50, 500]},
    {name: "Gold Scope 4", icon: "assets/icons/Gold_Scope_4.png", quality: "upg", size: 1, priceRange: [300, 2000]},
    {name: "Gold Scope 5", icon: "assets/icons/Gold_Scope_5.png", quality: "civ", size: 1, priceRange: [50, 500]},
    {name: "Gold Scope 6", icon: "assets/icons/Gold_Scope_6.png", quality: "upg", size: 1, priceRange: [300, 2000]},
    {name: "Gold Scope 7", icon: "assets/icons/Gold_Scope_7.png", quality: "civ", size: 1, priceRange: [50, 500]},
    {name: "Gold Scope 8", icon: "assets/icons/Gold_Scope_8.png", quality: "upg", size: 1, priceRange: [300, 2000]},
    {name: "Gold Scope 9", icon: "assets/icons/Gold_Scope_9.png", quality: "civ", size: 1, priceRange: [50, 500]},
    {name: "Gold Suppressor 1", icon: "assets/icons/Gold_Suppressor_1.png", quality: "civ", size: 1, priceRange: [50, 500]},
    {name: "Gold Suppressor 10", icon: "assets/icons/Gold_Suppressor_10.png", quality: "rar", size: 1, priceRange: [1500, 8000]},
    {name: "Gold Suppressor 11", icon: "assets/icons/Gold_Suppressor_11.png", quality: "rar", size: 1, priceRange: [1500, 8000]},
    {name: "Gold Suppressor 12", icon: "assets/icons/Gold_Suppressor_12.png", quality: "upg", size: 1, priceRange: [300, 2000]},
    {name: "Gold Suppressor 13", icon: "assets/icons/Gold_Suppressor_13.png", quality: "civ", size: 1, priceRange: [50, 500]},
    {name: "Gold Suppressor 14", icon: "assets/icons/Gold_Suppressor_14.png", quality: "upg", size: 1, priceRange: [300, 2000]},
    {name: "Gold Suppressor 15", icon: "assets/icons/Gold_Suppressor_15.png", quality: "upg", size: 1, priceRange: [300, 2000]},
    {name: "Gold Suppressor 16", icon: "assets/icons/Gold_Suppressor_16.png", quality: "upg", size: 1, priceRange: [300, 2000]},
    {name: "Gold Suppressor 2", icon: "assets/icons/Gold_Suppressor_2.png", quality: "upg", size: 1, priceRange: [300, 2000]},
    {name: "Gold Suppressor 3", icon: "assets/icons/Gold_Suppressor_3.png", quality: "civ", size: 1, priceRange: [50, 500]},
    {name: "Gold Suppressor 4", icon: "assets/icons/Gold_Suppressor_4.png", quality: "rar", size: 1, priceRange: [1500, 8000]},
    {name: "Gold Suppressor 5", icon: "assets/icons/Gold_Suppressor_5.png", quality: "upg", size: 1, priceRange: [300, 2000]},
    {name: "Gold Suppressor 6", icon: "assets/icons/Gold_Suppressor_6.png", quality: "upg", size: 1, priceRange: [300, 2000]},
    {name: "Gold Suppressor 7", icon: "assets/icons/Gold_Suppressor_7.png", quality: "upg", size: 1, priceRange: [300, 2000]},
    {name: "Gold Suppressor 8", icon: "assets/icons/Gold_Suppressor_8.png", quality: "rar", size: 1, priceRange: [1500, 8000]},
    {name: "Gold Suppressor 9", icon: "assets/icons/Gold_Suppressor_9.png", quality: "rar", size: 1, priceRange: [1500, 8000]},
    {name: "Gold Tactical Light 1", icon: "assets/icons/Gold_Tactical_Light_1.png", quality: "civ", size: 1, priceRange: [50, 500]},
    {name: "Gold Tactical Light 10", icon: "assets/icons/Gold_Tactical_Light_10.png", quality: "civ", size: 1, priceRange: [50, 500]},
    {name: "Gold Tactical Light 11", icon: "assets/icons/Gold_Tactical_Light_11.png", quality: "rar", size: 1, priceRange: [1500, 8000]},
    {name: "Gold Tactical Light 12", icon: "assets/icons/Gold_Tactical_Light_12.png", quality: "upg", size: 1, priceRange: [300, 2000]},
    {name: "Gold Tactical Light 13", icon: "assets/icons/Gold_Tactical_Light_13.png", quality: "rar", size: 1, priceRange: [1500, 8000]},
    {name: "Gold Tactical Light 14", icon: "assets/icons/Gold_Tactical_Light_14.png", quality: "civ", size: 1, priceRange: [50, 500]},
    {name: "Gold Tactical Light 15", icon: "assets/icons/Gold_Tactical_Light_15.png", quality: "upg", size: 1, priceRange: [300, 2000]},
    {name: "Gold Tactical Light 16", icon: "assets/icons/Gold_Tactical_Light_16.png", quality: "upg", size: 1, priceRange: [300, 2000]},
    {name: "Gold Tactical Light 2", icon: "assets/icons/Gold_Tactical_Light_2.png", quality: "upg", size: 1, priceRange: [300, 2000]},
    {name: "Gold Tactical Light 3", icon: "assets/icons/Gold_Tactical_Light_3.png", quality: "civ", size: 1, priceRange: [50, 500]},
    {name: "Gold Tactical Light 4", icon: "assets/icons/Gold_Tactical_Light_4.png", quality: "civ", size: 1, priceRange: [50, 500]},
    {name: "Gold Tactical Light 5", icon: "assets/icons/Gold_Tactical_Light_5.png", quality: "rar", size: 1, priceRange: [1500, 8000]},
    {name: "Gold Tactical Light 6", icon: "assets/icons/Gold_Tactical_Light_6.png", quality: "upg", size: 1, priceRange: [300, 2000]},
    {name: "Gold Tactical Light 7", icon: "assets/icons/Gold_Tactical_Light_7.png", quality: "civ", size: 1, priceRange: [50, 500]},
    {name: "Gold Tactical Light 8", icon: "assets/icons/Gold_Tactical_Light_8.png", quality: "rar", size: 1, priceRange: [1500, 8000]},
    {name: "Gold Tactical Light 9", icon: "assets/icons/Gold_Tactical_Light_9.png", quality: "civ", size: 1, priceRange: [50, 500]},
    {name: "Silver Grip 1", icon: "assets/icons/Silver_Grip_1.png", quality: "civ", size: 1, priceRange: [50, 500]},
    {name: "Silver Grip 10", icon: "assets/icons/Silver_Grip_10.png", quality: "rar", size: 1, priceRange: [1500, 8000]},
    {name: "Silver Grip 11", icon: "assets/icons/Silver_Grip_11.png", quality: "civ", size: 1, priceRange: [50, 500]},
    {name: "Silver Grip 12", icon: "assets/icons/Silver_Grip_12.png", quality: "upg", size: 1, priceRange: [300, 2000]},
    {name: "Silver Grip 13", icon: "assets/icons/Silver_Grip_13.png", quality: "rar", size: 1, priceRange: [1500, 8000]},
    {name: "Silver Grip 14", icon: "assets/icons/Silver_Grip_14.png", quality: "upg", size: 1, priceRange: [300, 2000]},
    {name: "Silver Grip 15", icon: "assets/icons/Silver_Grip_15.png", quality: "rar", size: 1, priceRange: [1500, 8000]},
    {name: "Silver Grip 16", icon: "assets/icons/Silver_Grip_16.png", quality: "upg", size: 1, priceRange: [300, 2000]},
    {name: "Silver Grip 2", icon: "assets/icons/Silver_Grip_2.png", quality: "upg", size: 1, priceRange: [300, 2000]},
    {name: "Silver Grip 3", icon: "assets/icons/Silver_Grip_3.png", quality: "civ", size: 1, priceRange: [50, 500]},
    {name: "Silver Grip 4", icon: "assets/icons/Silver_Grip_4.png", quality: "upg", size: 1, priceRange: [300, 2000]},
    {name: "Silver Grip 5", icon: "assets/icons/Silver_Grip_5.png", quality: "upg", size: 1, priceRange: [300, 2000]},
    {name: "Silver Grip 7", icon: "assets/icons/Silver_Grip_7.png", quality: "rar", size: 1, priceRange: [1500, 8000]},
    {name: "Silver Grip 8", icon: "assets/icons/Silver_Grip_8.png", quality: "upg", size: 1, priceRange: [300, 2000]},
    {name: "Silver Grip 9", icon: "assets/icons/Silver_Grip_9.png", quality: "civ", size: 1, priceRange: [50, 500]},
    {name: "Silver Magazine 1", icon: "assets/icons/Silver_Magazine_1.png", quality: "civ", size: 1, priceRange: [50, 500]},
    {name: "Silver Magazine 10", icon: "assets/icons/Silver_Magazine_10.png", quality: "upg", size: 1, priceRange: [300, 2000]},
    {name: "Silver Magazine 11", icon: "assets/icons/Silver_Magazine_11.png", quality: "upg", size: 1, priceRange: [300, 2000]},
    {name: "Silver Magazine 12", icon: "assets/icons/Silver_Magazine_12.png", quality: "civ", size: 1, priceRange: [50, 500]},
    {name: "Silver Magazine 13", icon: "assets/icons/Silver_Magazine_13.png", quality: "upg", size: 1, priceRange: [300, 2000]},
    {name: "Silver Magazine 14", icon: "assets/icons/Silver_Magazine_14.png", quality: "rar", size: 1, priceRange: [1500, 8000]},
    {name: "Silver Magazine 15", icon: "assets/icons/Silver_Magazine_15.png", quality: "upg", size: 1, priceRange: [300, 2000]},
    {name: "Silver Magazine 16", icon: "assets/icons/Silver_Magazine_16.png", quality: "civ", size: 1, priceRange: [50, 500]},
    {name: "Silver Magazine 2", icon: "assets/icons/Silver_Magazine_2.png", quality: "upg", size: 1, priceRange: [300, 2000]},
    {name: "Silver Magazine 3", icon: "assets/icons/Silver_Magazine_3.png", quality: "rar", size: 1, priceRange: [1500, 8000]},
    {name: "Silver Magazine 4", icon: "assets/icons/Silver_Magazine_4.png", quality: "civ", size: 1, priceRange: [50, 500]},
    {name: "Silver Magazine 5", icon: "assets/icons/Silver_Magazine_5.png", quality: "civ", size: 1, priceRange: [50, 500]},
    {name: "Silver Magazine 6", icon: "assets/icons/Silver_Magazine_6.png", quality: "upg", size: 1, priceRange: [300, 2000]},
    {name: "Silver Magazine 7", icon: "assets/icons/Silver_Magazine_7.png", quality: "civ", size: 1, priceRange: [50, 500]},
    {name: "Silver Magazine 8", icon: "assets/icons/Silver_Magazine_8.png", quality: "upg", size: 1, priceRange: [300, 2000]},
    {name: "Silver Magazine 9", icon: "assets/icons/Silver_Magazine_9.png", quality: "upg", size: 1, priceRange: [300, 2000]},
    {name: "Silver Reflex Sight 1", icon: "assets/icons/Silver_Reflex_Sight_1.png", quality: "upg", size: 1, priceRange: [300, 2000]},
    {name: "Silver Reflex Sight 10", icon: "assets/icons/Silver_Reflex_Sight_10.png", quality: "rar", size: 1, priceRange: [1500, 8000]},
    {name: "Silver Reflex Sight 11", icon: "assets/icons/Silver_Reflex_Sight_11.png", quality: "rar", size: 1, priceRange: [1500, 8000]},
    {name: "Silver Reflex Sight 12", icon: "assets/icons/Silver_Reflex_Sight_12.png", quality: "civ", size: 1, priceRange: [50, 500]},
    {name: "Silver Reflex Sight 13", icon: "assets/icons/Silver_Reflex_Sight_13.png", quality: "rar", size: 1, priceRange: [1500, 8000]},
    {name: "Silver Reflex Sight 14", icon: "assets/icons/Silver_Reflex_Sight_14.png", quality: "rar", size: 1, priceRange: [1500, 8000]},
    {name: "Silver Reflex Sight 15", icon: "assets/icons/Silver_Reflex_Sight_15.png", quality: "civ", size: 1, priceRange: [50, 500]},
    {name: "Silver Reflex Sight 16", icon: "assets/icons/Silver_Reflex_Sight_16.png", quality: "civ", size: 1, priceRange: [50, 500]},
    {name: "Silver Reflex Sight 2", icon: "assets/icons/Silver_Reflex_Sight_2.png", quality: "rar", size: 1, priceRange: [1500, 8000]},
    {name: "Silver Reflex Sight 3", icon: "assets/icons/Silver_Reflex_Sight_3.png", quality: "civ", size: 1, priceRange: [50, 500]},
    {name: "Silver Reflex Sight 4", icon: "assets/icons/Silver_Reflex_Sight_4.png", quality: "civ", size: 1, priceRange: [50, 500]},
    {name: "Silver Reflex Sight 5", icon: "assets/icons/Silver_Reflex_Sight_5.png", quality: "upg", size: 1, priceRange: [300, 2000]},
    {name: "Silver Reflex Sight 6", icon: "assets/icons/Silver_Reflex_Sight_6.png", quality: "civ", size: 1, priceRange: [50, 500]},
    {name: "Silver Reflex Sight 7", icon: "assets/icons/Silver_Reflex_Sight_7.png", quality: "civ", size: 1, priceRange: [50, 500]},
    {name: "Silver Reflex Sight 8", icon: "assets/icons/Silver_Reflex_Sight_8.png", quality: "upg", size: 1, priceRange: [300, 2000]},
    {name: "Silver Reflex Sight 9", icon: "assets/icons/Silver_Reflex_Sight_9.png", quality: "civ", size: 1, priceRange: [50, 500]},
    {name: "Silver Scope 1", icon: "assets/icons/Silver_Scope_1.png", quality: "rar", size: 1, priceRange: [1500, 8000]},
    {name: "Silver Scope 10", icon: "assets/icons/Silver_Scope_10.png", quality: "upg", size: 1, priceRange: [300, 2000]},
    {name: "Silver Scope 11", icon: "assets/icons/Silver_Scope_11.png", quality: "civ", size: 1, priceRange: [50, 500]},
    {name: "Silver Scope 12", icon: "assets/icons/Silver_Scope_12.png", quality: "civ", size: 1, priceRange: [50, 500]},
    {name: "Silver Scope 13", icon: "assets/icons/Silver_Scope_13.png", quality: "upg", size: 1, priceRange: [300, 2000]},
    {name: "Silver Scope 14", icon: "assets/icons/Silver_Scope_14.png", quality: "upg", size: 1, priceRange: [300, 2000]},
    {name: "Silver Scope 15", icon: "assets/icons/Silver_Scope_15.png", quality: "civ", size: 1, priceRange: [50, 500]},
    {name: "Silver Scope 16", icon: "assets/icons/Silver_Scope_16.png", quality: "upg", size: 1, priceRange: [300, 2000]},
    {name: "Silver Scope 2", icon: "assets/icons/Silver_Scope_2.png", quality: "rar", size: 1, priceRange: [1500, 8000]},
    {name: "Silver Scope 3", icon: "assets/icons/Silver_Scope_3.png", quality: "rar", size: 1, priceRange: [1500, 8000]},
    {name: "Silver Scope 4", icon: "assets/icons/Silver_Scope_4.png", quality: "upg", size: 1, priceRange: [300, 2000]},
    {name: "Silver Scope 5", icon: "assets/icons/Silver_Scope_5.png", quality: "rar", size: 1, priceRange: [1500, 8000]},
    {name: "Silver Scope 6", icon: "assets/icons/Silver_Scope_6.png", quality: "civ", size: 1, priceRange: [50, 500]},
    {name: "Silver Scope 7", icon: "assets/icons/Silver_Scope_7.png", quality: "rar", size: 1, priceRange: [1500, 8000]},
    {name: "Silver Scope 8", icon: "assets/icons/Silver_Scope_8.png", quality: "upg", size: 1, priceRange: [300, 2000]},
    {name: "Silver Scope 9", icon: "assets/icons/Silver_Scope_9.png", quality: "rar", size: 1, priceRange: [1500, 8000]},
    {name: "Silver Suppressor 1", icon: "assets/icons/Silver_Suppressor_1.png", quality: "civ", size: 1, priceRange: [50, 500]},
    {name: "Silver Suppressor 10", icon: "assets/icons/Silver_Suppressor_10.png", quality: "civ", size: 1, priceRange: [50, 500]},
    {name: "Silver Suppressor 11", icon: "assets/icons/Silver_Suppressor_11.png", quality: "civ", size: 1, priceRange: [50, 500]},
    {name: "Silver Suppressor 12", icon: "assets/icons/Silver_Suppressor_12.png", quality: "rar", size: 1, priceRange: [1500, 8000]},
    {name: "Silver Suppressor 13", icon: "assets/icons/Silver_Suppressor_13.png", quality: "upg", size: 1, priceRange: [300, 2000]},
    {name: "Silver Suppressor 14", icon: "assets/icons/Silver_Suppressor_14.png", quality: "civ", size: 1, priceRange: [50, 500]},
    {name: "Silver Suppressor 15", icon: "assets/icons/Silver_Suppressor_15.png", quality: "upg", size: 1, priceRange: [300, 2000]},
    {name: "Silver Suppressor 16", icon: "assets/icons/Silver_Suppressor_16.png", quality: "rar", size: 1, priceRange: [1500, 8000]},
    {name: "Silver Suppressor 2", icon: "assets/icons/Silver_Suppressor_2.png", quality: "rar", size: 1, priceRange: [1500, 8000]},
    {name: "Silver Suppressor 3", icon: "assets/icons/Silver_Suppressor_3.png", quality: "civ", size: 1, priceRange: [50, 500]},
    {name: "Silver Suppressor 4", icon: "assets/icons/Silver_Suppressor_4.png", quality: "rar", size: 1, priceRange: [1500, 8000]},
    {name: "Silver Suppressor 5", icon: "assets/icons/Silver_Suppressor_5.png", quality: "rar", size: 1, priceRange: [1500, 8000]},
    {name: "Silver Suppressor 6", icon: "assets/icons/Silver_Suppressor_6.png", quality: "rar", size: 1, priceRange: [1500, 8000]},
    {name: "Silver Suppressor 7", icon: "assets/icons/Silver_Suppressor_7.png", quality: "upg", size: 1, priceRange: [300, 2000]},
    {name: "Silver Suppressor 8", icon: "assets/icons/Silver_Suppressor_8.png", quality: "civ", size: 1, priceRange: [50, 500]},
    {name: "Silver Suppressor 9", icon: "assets/icons/Silver_Suppressor_9.png", quality: "civ", size: 1, priceRange: [50, 500]},
    {name: "Silver Tactical Light 1", icon: "assets/icons/Silver_Tactical_Light_1.png", quality: "civ", size: 1, priceRange: [50, 500]},
    {name: "Silver Tactical Light 10", icon: "assets/icons/Silver_Tactical_Light_10.png", quality: "civ", size: 1, priceRange: [50, 500]},
    {name: "Silver Tactical Light 11", icon: "assets/icons/Silver_Tactical_Light_11.png", quality: "civ", size: 1, priceRange: [50, 500]},
    {name: "Silver Tactical Light 12", icon: "assets/icons/Silver_Tactical_Light_12.png", quality: "upg", size: 1, priceRange: [300, 2000]},
    {name: "Silver Tactical Light 13", icon: "assets/icons/Silver_Tactical_Light_13.png", quality: "rar", size: 1, priceRange: [1500, 8000]},
    {name: "Silver Tactical Light 14", icon: "assets/icons/Silver_Tactical_Light_14.png", quality: "civ", size: 1, priceRange: [50, 500]},
    {name: "Silver Tactical Light 15", icon: "assets/icons/Silver_Tactical_Light_15.png", quality: "rar", size: 1, priceRange: [1500, 8000]},
    {name: "Silver Tactical Light 16", icon: "assets/icons/Silver_Tactical_Light_16.png", quality: "rar", size: 1, priceRange: [1500, 8000]},
    {name: "Silver Tactical Light 2", icon: "assets/icons/Silver_Tactical_Light_2.png", quality: "civ", size: 1, priceRange: [50, 500]},
    {name: "Silver Tactical Light 3", icon: "assets/icons/Silver_Tactical_Light_3.png", quality: "civ", size: 1, priceRange: [50, 500]},
    {name: "Silver Tactical Light 4", icon: "assets/icons/Silver_Tactical_Light_4.png", quality: "civ", size: 1, priceRange: [50, 500]},
    {name: "Silver Tactical Light 5", icon: "assets/icons/Silver_Tactical_Light_5.png", quality: "civ", size: 1, priceRange: [50, 500]},
    {name: "Silver Tactical Light 6", icon: "assets/icons/Silver_Tactical_Light_6.png", quality: "civ", size: 1, priceRange: [50, 500]},
    {name: "Silver Tactical Light 7", icon: "assets/icons/Silver_Tactical_Light_7.png", quality: "civ", size: 1, priceRange: [50, 500]},
    {name: "Silver Tactical Light 8", icon: "assets/icons/Silver_Tactical_Light_8.png", quality: "civ", size: 1, priceRange: [50, 500]},
    {name: "Silver Tactical Light 9", icon: "assets/icons/Silver_Tactical_Light_9.png", quality: "rar", size: 1, priceRange: [1500, 8000]}
  ],
  // 特殊物品 (50件)
  special: [
    {name: "Ancient Coins", icon: "assets/icons/Ancient_Coins.png", quality: "epi", size: 1, priceRange: [8000, 40000]},
    {name: "BLUE Labs Card", icon: "assets/icons/BLUE_Labs_Card.png", quality: "rar", size: 1, priceRange: [1500, 8000]},
    {name: "Battery Packs", icon: "assets/icons/Battery_Packs.png", quality: "rar", size: 1, priceRange: [1500, 8000]},
    {name: "Battery Unit", icon: "assets/icons/Battery_Unit.png", quality: "leg", size: 1, priceRange: [40000, 200000]},
    {name: "Binoculars Case", icon: "assets/icons/Binoculars_Case.png", quality: "epi", size: 1, priceRange: [8000, 40000]},
    {name: "CPU Module", icon: "assets/icons/CPU_Module.png", quality: "upg", size: 1, priceRange: [300, 2000]},
    {name: "Equipment Case", icon: "assets/icons/Equipment_Case.png", quality: "upg", size: 1, priceRange: [300, 2000]},
    {name: "Field Radio", icon: "assets/icons/Field_Radio.png", quality: "rar", size: 1, priceRange: [1500, 8000]},
    {name: "Flashlight Set", icon: "assets/icons/Flashlight_Set.png", quality: "rar", size: 1, priceRange: [1500, 8000]},
    {name: "GRAY Labs Cards", icon: "assets/icons/GRAY_Labs_Cards.png", quality: "leg", size: 1, priceRange: [40000, 200000]},
    {name: "GREEN Access Card", icon: "assets/icons/GREEN_Access_Card.png", quality: "rar", size: 1, priceRange: [1500, 8000]},
    {name: "Golden Warrior", icon: "assets/icons/Golden_Warrior.png", quality: "epi", size: 1, priceRange: [8000, 40000]},
    {name: "Gun Cleaning Kit", icon: "assets/icons/Gun_Cleaning_Kit.png", quality: "upg", size: 1, priceRange: [300, 2000]},
    {name: "Heavy Container", icon: "assets/icons/Heavy_Container.png", quality: "rar", size: 1, priceRange: [1500, 8000]},
    {name: "Jade Dragon Seal", icon: "assets/icons/Jade_Dragon_Seal.png", quality: "leg", size: 1, priceRange: [40000, 200000]},
    {name: "Jewelry Set", icon: "assets/icons/Jewelry_Set.png", quality: "rar", size: 1, priceRange: [1500, 8000]},
    {name: "Leather Portfolio", icon: "assets/icons/Leather_Portfolio.png", quality: "upg", size: 1, priceRange: [300, 2000]},
    {name: "Ornate Dagger", icon: "assets/icons/Ornate_Dagger.png", quality: "epi", size: 1, priceRange: [8000, 40000]},
    {name: "Pottery Shard", icon: "assets/icons/Pottery_Shard.png", quality: "leg", size: 1, priceRange: [40000, 200000]},
    {name: "RED Access Card", icon: "assets/icons/RED_Access_Card.png", quality: "upg", size: 1, priceRange: [300, 2000]},
    {name: "Rugged Laptop", icon: "assets/icons/Rugged_Laptop.png", quality: "epi", size: 1, priceRange: [8000, 40000]},
    {name: "Satellite Dish", icon: "assets/icons/Satellite_Dish.png", quality: "upg", size: 1, priceRange: [300, 2000]},
    {name: "Scroll Cases", icon: "assets/icons/Scroll_Cases.png", quality: "rar", size: 1, priceRange: [1500, 8000]},
    {name: "Secure Case", icon: "assets/icons/Secure_Case.png", quality: "upg", size: 1, priceRange: [300, 2000]},
    {name: "Tactical Tablet", icon: "assets/icons/Tactical_Tablet.png", quality: "upg", size: 1, priceRange: [300, 2000]},
    {name: "Weapon Parts", icon: "assets/icons/Weapon_Parts.png", quality: "epi", size: 1, priceRange: [8000, 40000]},
    {name: "Ancient Books", icon: "assets/icons/Ancient_Books.png", quality: "leg", size: 2, priceRange: [40000, 200000]},
    {name: "Canopic Jar", icon: "assets/icons/Canopic_Jar.png", quality: "epi", size: 2, priceRange: [8000, 40000]},
    {name: "Crown", icon: "assets/icons/Crown.png", quality: "myt", size: 2, priceRange: [150000, 1000000]},
    {name: "Cryo Safe", icon: "assets/icons/Cryo_Safe.png", quality: "myt", size: 2, priceRange: [150000, 1000000]},
    {name: "Diamond Ring Box", icon: "assets/icons/Diamond_Ring_Box.png", quality: "leg", size: 2, priceRange: [40000, 200000]},
    {name: "Encrypted Drive", icon: "assets/icons/Encrypted_Drive.png", quality: "leg", size: 2, priceRange: [40000, 200000]},
    {name: "Energy Cell", icon: "assets/icons/Energy_Cell.png", quality: "myt", size: 2, priceRange: [150000, 1000000]},
    {name: "Energy Core", icon: "assets/icons/Energy_Core.png", quality: "leg", size: 2, priceRange: [40000, 200000]},
    {name: "Fingerprint Card Set", icon: "assets/icons/Fingerprint_Card_Set.png", quality: "leg", size: 2, priceRange: [40000, 200000]},
    {name: "Fingerprint Scanner", icon: "assets/icons/Fingerprint_Scanner.png", quality: "leg", size: 2, priceRange: [40000, 200000]},
    {name: "Ivory Horn", icon: "assets/icons/Ivory_Horn.png", quality: "epi", size: 2, priceRange: [8000, 40000]},
    {name: "Meteorite", icon: "assets/icons/Meteorite.png", quality: "leg", size: 2, priceRange: [40000, 200000]},
    {name: "Open Ancient Book", icon: "assets/icons/Open_Ancient_Book.png", quality: "myt", size: 2, priceRange: [150000, 1000000]},
    {name: "Organ Tray", icon: "assets/icons/Organ_Tray.png", quality: "epi", size: 2, priceRange: [8000, 40000]},
    {name: "Pocket Watch", icon: "assets/icons/Pocket_Watch.png", quality: "leg", size: 2, priceRange: [40000, 200000]},
    {name: "Retro Phone Blue", icon: "assets/icons/Retro_Phone_Blue.png", quality: "epi", size: 2, priceRange: [8000, 40000]},
    {name: "Retro Phone Brown", icon: "assets/icons/Retro_Phone_Brown.png", quality: "myt", size: 2, priceRange: [150000, 1000000]},
    {name: "Retro Phone Gold", icon: "assets/icons/Retro_Phone_Gold.png", quality: "epi", size: 2, priceRange: [8000, 40000]},
    {name: "Retro Phone Gray", icon: "assets/icons/Retro_Phone_Gray.png", quality: "myt", size: 2, priceRange: [150000, 1000000]},
    {name: "Retro Phone Red", icon: "assets/icons/Retro_Phone_Red.png", quality: "leg", size: 2, priceRange: [40000, 200000]},
    {name: "Robotic Arm", icon: "assets/icons/Robotic_Arm.png", quality: "leg", size: 2, priceRange: [40000, 200000]},
    {name: "Sapphire Set Box", icon: "assets/icons/Sapphire_Set_Box.png", quality: "epi", size: 2, priceRange: [8000, 40000]},
    {name: "Security Briefcase", icon: "assets/icons/Security_Briefcase.png", quality: "epi", size: 2, priceRange: [8000, 40000]},
    {name: "Star Chart Case", icon: "assets/icons/Star_Chart_Case.png", quality: "myt", size: 2, priceRange: [150000, 1000000]}
  ]
};
...
detail.style.display='block';const isLeft=pos.x<50;detail.style.left=isLeft?(pos.x+5)+'%':'auto';detail.style.right=isLeft?'auto':(100-pos.x+5)+'%';detail.style.top=Math.min(Math.max(pos.y-10,5),55)+'%';detail.style.maxHeight='40vh';detail.style.overflowY='auto';},
  ...
  refreshGrowth(){const d=GameData.data;document.getElementById('playerLevel').textContent='Lv.'+d.player.level;document.getElementById('growthLevel').textContent='Lv.'+d.player.level;const need=d.player.level*100,pct=Math.min(100,(d.player.exp/need)*100);document.getElementById('growthExp').textContent=d.player.exp+'/'+need;document.getElementById('expBar').style.width=pct+'%';const sl=document.getElementById('skillList');sl.innerHTML='';SKILLS.forEach(s=>{const lv=d.skills[s.key];const cost=Math.floor(s.costBase*Math.pow(1.10,lv-1));const maxed=lv>=s.maxLevel;const nextCost=maxed?0:Math.floor(s.costBase*Math.pow(1.10,lv));const div=document.createElement('div');div.className='skill-item';const effectText=s.effectDesc?s.effectDesc(lv):s.desc;const nextEffectText=maxed?'已满级':s.effect?s.effect(lv+1):'';div.innerHTML=`<div class="skill-item__info"><span class="skill-item__name">${s.icon||''} ${s.name}</span><span class="skill-item__level">Lv.${lv} · ${effectText}${!maxed?' → <small style="color:var(--color-success)">Lv.'+(lv+1)+' '+nextEffectText+'</small>':''}</span></div><button class="btn btn--sm btn--primary skill-item__btn" ${maxed||d.player.gold<cost?'disabled':''}>${maxed?'已满级':'💰'+formatGold(cost)}</button>`;if(!maxed)div.querySelector('button').addEventListener('click',()=>this.upgradeSkill(s.key,cost));sl.appendChild(div);});document.getElementById('statLooted').textContent=d.stats.totalLooted;document.getElementById('statAppraised').textContent=d.stats.totalAppraised;document.getElementById('statSold').textContent=d.stats.totalSold;document.getElementById('statEarned').textContent=formatGold(d.stats.totalEarned);},
